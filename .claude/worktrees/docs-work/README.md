...
1. **M1: Input Capture** ✅
   ...
   - MultitouchSupport bridge working; live finger dots, event log, diagnostics.
2. **M2: Character Emission** _(next)_
   - Touch regions emit characters into output buffer.
